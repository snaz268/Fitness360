...
<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    $_c_id = $_POST['c_id'];
    $query1 = "DELETE FROM COACH WHERE c_id = $_c_id ";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <span class="section">Delete Coach</span>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="locker_id">Coach ID <span class="required">*</span> </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
							           <?php 
				                  $query = "SELECT c_id FROM coach order by c_id asc";
                          $result= mysqli_query($conn,$query);
                          echo "<select name='c_id'>";
                          while ($row = $result->fetch_assoc()) {
                            unset($_c_id);
                            $_c_id = $row['c_id'];
                            echo '<option value='.$_c_id.'>'.$_c_id.'</option>';
                          }
                          echo "</select>";
				                  ?>
                        </div>
