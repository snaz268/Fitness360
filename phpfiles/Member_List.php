...
if($_SERVER["REQUEST_METHOD"]=="POST"){
 $_m_id = $_POST['m_id'];
$query1 = "DELETE FROM MEMBER WHERE m_id = '$_m_id'";
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;"><a href="index.php" class="site_title"><em class="fa fa-paw"></em> Fitness360</a></div>
